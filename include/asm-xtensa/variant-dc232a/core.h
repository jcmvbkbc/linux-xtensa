...
#define XCHAL_CORE_ID			"dc232a"	/* alphanum core name
						   (CoreID) set in the Xtensa
						   Processor Generator */

#define XCHAL_CORE_DESCRIPTION		"Diamond 232L Standard Core Rev.A (LE)"
#define XCHAL_BUILD_UNIQUE_ID		0x0000BEEF	/* 22-bit sw build ID */

/*
 *  These definitions describe the hardware targeted by this software.
 */
#define XCHAL_HW_CONFIGID0		0xC50305FE	/* ConfigID hi 32 bits*/
#define XCHAL_HW_CONFIGID1		0x05C0BEEF	/* ConfigID lo 32 bits*/
#define XCHAL_HW_VERSION_NAME		"LX1.0.4"	/* (X6.0.4) full version name */
#define XCHAL_HW_VERSION_MAJOR		2100	/* major ver# of targeted hw */
#define XCHAL_HW_VERSION_MINOR		4	/* minor ver# of targeted hw */
#define XCHAL_HW_VERSION		210004	/* major*100+minor */
#define XCHAL_HW_REL_LX1		1
#define XCHAL_HW_REL_LX1_0		1
#define XCHAL_HW_REL_LX1_0_4		1
...
#define XCHAL_HW_MIN_VERSION		210004	/* earliest targeted hw */
...
#define XCHAL_HW_MAX_VERSION		210004	/* latest targeted hw */

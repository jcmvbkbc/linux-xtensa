/*
 * include/asm-xtensa/core/gdb-regs.h
 *
...
#ifndef _XTENSA_XT_GDB_REGS_H
#define _XTENSA_XT_GDB_REGS_H

/*
 * Gdb offsets for xt-gdb are defined in Software/libdb/xtensa-libdb-macros.h
 */

...
#define XCHAL_CORE_ID			"test_mmuhifi"	/* alphanum core name
						   (CoreID) set in the Xtensa
						   Processor Generator */

#define XCHAL_CORE_DESCRIPTION		"Test Core with MMU and HiFi2 (A)"
#define XCHAL_BUILD_UNIQUE_ID		0x00005E32	/* 22-bit sw build ID */

/*
 *  These definitions describe the hardware targeted by this software.
 */
#define XCHAL_HW_CONFIGID0		0xC1B3DFFE	/* ConfigID hi 32 bits*/
#define XCHAL_HW_CONFIGID1		0x0D405E32	/* ConfigID lo 32 bits*/

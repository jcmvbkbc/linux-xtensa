...
#define XCHAL_CORE_DESCRIPTION		"Base Xtensa with MMU (LE)"
...
#define XCHAL_HW_CONFIGID1		0x0D400081	/* ConfigID lo 32 bits*/
#define XCHAL_HW_VERSION_NAME		"LX2.1.1"	/* (X7.1.1) full version name */

...
#define XCHAL_CORE_ID			"test_mmuhifi_b"	/* alphanum core name
						   (CoreID) set in the Xtensa
						   Processor Generator */

#define XCHAL_CORE_DESCRIPTION		"Test Core with MMU and HiFi2 (B)"
#define XCHAL_BUILD_UNIQUE_ID		0x00005A6A	/* 22-bit sw build ID */

/*
 *  These definitions describe the hardware targeted by this software.
 */
#define XCHAL_HW_CONFIGID0		0xC1B3C9FE	/* ConfigID hi 32 bits*/
#define XCHAL_HW_CONFIGID1		0x0D405A6A	/* ConfigID lo 32 bits*/
...
#define XCHAL_NUM_EXTINTERRUPTS		6	/* num of external interrupts */
...
#define XCHAL_INTLEVEL4_ANDBELOW_MASK	0x000001FF
...
#define XCHAL_INTLEVEL3_VECTOR_VADDR	0xD0000280
#define XCHAL_INTLEVEL3_VECTOR_PADDR	0x00000280
